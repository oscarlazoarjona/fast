...
project = 'FAST'
copyright = '2017 Oscar Gerardo Lazo Arjona'
...
latex_documents = [('index', 'sympy-%s.tex' % release, 'FAST Documentation',
                    'Oscar Gerardo Lazo Arjona', 'manual', True)]
...
texinfo_documents = [
    (master_doc, 'fast', 'FAST Documentation', 'Oscar Gerardo Lazo Arjona',
   'FAST', 'Atomic Spectroscopy', 'Programming', 1),
]
