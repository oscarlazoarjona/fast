...
<matplotlib.figure.Figure at 0x7fbde017ac50>
...
<matplotlib.figure.Figure at 0x7fbde017afd0>
...
[                                                                                                                  2  
<BLANKLINE>
 -I*omega_21*t _____               I*omega^2*t  -I*omega_21*t _____                                                   
...
[E_0^1*e*r_{0;21}*e            *e                                                            e*r_{0;32}*e           *e
[--------------------------------------------                       0                        -------------------------
[                     2                                                                                           2   
[                                                                                                                     
...
[--------------------------------- + --------------------------------- - hbar*omega^1*\tilde{c}_{2}(t) + hbar*omega_2*
[                2                                   2                                                                
[                                                                                                                     
[  E_0^2*e*r_{0;32}*\tilde{c}_{2}(t)                                                                                  
[  --------------------------------- - hbar*omega^1*\tilde{c}_{3}(t) - hbar*omega^2*\tilde{c}_{3}(t) + hbar*omega_3*\t
[                  2                                                                                                  
<BLANKLINE>
                                               ]
                                               ]
...
[                                                                                                                     
[                                         E_0^2*e*r_{0;32}                                                            
[            0                            ----------------               -hbar*omega^1 - hbar*omega^2 + hbar*omega_3 +
[                                                2                                                                    
<BLANKLINE>
            ]
            ]
